...
class FakeManager:
    ...
    def start(self, port):
        ...
        self.state = "online"
        return {"state": "online", "public_url": "https://tape-abc123.tape.hyzhn.com", "error": ""}
    ...
    def status(self):
        url = "https://tape-abc123.tape.hyzhn.com" if self.state == "online" else ""
...
def test_start_uses_runtime_port_and_builds_urls(ctx):
    ...
    assert j["url"] == "https://tape-abc123.tape.hyzhn.com"
    assert j["mobile_url"] == "https://tape-abc123.tape.hyzhn.com/m"
